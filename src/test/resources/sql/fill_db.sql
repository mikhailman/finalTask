...
INSERT INTO `kefir_test`.`users`(`id`, `role`, `login`, `password`, `email`, `phone`, `name`, `surname`, `status`,
                                 `date_registration`)
VALUES (DEFAULT, 1, 'admin', 'password', 'admin@mail.ru', '375292020327', 'valera', 'valerin', DEFAULT, DEFAULT);
INSERT INTO `kefir_test`.`users`(`id`, `role`, `login`, `password`, `email`, `phone`, `name`, `surname`, `status`,
                                 `date_registration`)
...
INSERT INTO `kefir_test`.`category` (`id`, `name`)
VALUES (DEFAULT, 'Бытовая техника');
INSERT INTO `kefir_test`.`category` (`id`, `name`)
VALUES (DEFAULT, 'Крупная бытовая техника');
INSERT INTO `kefir_test`.`category` (`id`, `name`)
VALUES (DEFAULT, 'Мелкая бытовая техника');
INSERT INTO `kefir_test`.`location` (`id`, `name`, `city`)
VALUES (DEFAULT, 'Nezavisimosti,4', 'Minsk');
INSERT INTO `kefir_test`.`location` (`id`, `name`, `city`)
VALUES (DEFAULT, 'Orlovskaya,19', 'Pinsk');
INSERT INTO `kefir_test`.`products` (`id`, `name`, `description`, `price`, `date_creation`, `users_id`, `category_id`,
                                     `location_id`)
...
INSERT INTO `kefir_test`.`images` (`id`, `name`, `image_path`, `products_id`)
...
VALUES (DEFAULT, 'phone_image',
        ...
        13);
INSERT INTO `kefir_test`.`comments` (`id`, `name`, `body`, `users_id`, `products_id`)
