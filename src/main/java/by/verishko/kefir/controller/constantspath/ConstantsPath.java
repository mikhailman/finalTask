...
public final class ConstantsPath {
    ...
    public static final String LOGIN_PAGE_ADMIN = "/WEB-INF/jsp/profileAdmin.jsp";
    public static final String LOGIN_PAGE_USER = "/WEB-INF/jsp/profileUser.jsp";
    public static final String LOGIN_PAGE = "/WEB-INF/jsp/login.jsp";
    public static final String LOGIN_PAGE_HTML = "/loginPage.html";
    public static final String ERROR_PAGE = "/WEB-INF/jsp/error.jsp";
    public static final String MY_PROFILE = "/WEB-INF/jsp/profile.jsp";
